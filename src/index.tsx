...
const pageContent: { [key: string]: { [key: string]: any } } = {
  terms: {
    ja: {
      ...
      sections: [
        ...
        { title: '第3条（料金）', list: ['無料プラン：30,000文字まで（一度限り）', 'スタンダードプラン：1,000円で500,000文字', 'プレミアムプラン：10,000円で6,000,000文字'] },
    ...
    en: {
      ...
      sections: [
        ...
        { title: 'Article 3 (Pricing)', list: ['Free Plan: Up to 30,000 characters (one-time)', 'Standard Plan: ¥1,000 for 500,000 characters', 'Premium Plan: ¥10,000 for 6,000,000 characters'] },
    ...
    zh: {
      ...
      sections: [
        ...
        { title: '第3条（费用）', list: ['免费方案：最多30,000字符（仅限一次）', '标准方案：1,000日元可获得500,000字符', '高级方案：10,000日元可获得6,000,000字符'] },
    ...
    ko: {
      ...
      sections: [
        ...
        { title: '제3조 (요금)', list: ['무료 플랜: 30,000자까지 (1회 한정)', '스탠다드 플랜: 1,000엔으로 500,000자', '프리미엄 플랜: 10,000엔으로 6,000,000자'] },
    ...
    it: {
      ...
      sections: [
        ...
        { title: 'Articolo 3 (Prezzi)', list: ['Piano Gratuito: fino a 30.000 caratteri (una tantum)', 'Piano Standard: ¥1.000 per 500.000 caratteri', 'Piano Premium: ¥10.000 per 6.000.000 caratteri'] },
    ...
    hi: {
      ...
      sections: [
        ...
        { title: 'अनुच्छेद 3 (मूल्य निर्धारण)', list: ['निःशुल्क योजना: 30,000 अक्षरों तक (एक बार)', 'स्टैंडर्ड योजना: ¥1,000 में 500,000 अक्षर', 'प्रीमियम योजना: ¥10,000 में 6,000,000 अक्षर'] },
  ...
  help: {
    ...
    en: {
      ...
      free: 'Free Plan',
      freeDesc: 'Up to 30,000 characters (one-time)',
      standard: 'Standard',
    ...
    it: {
      ...
      free: 'Piano Gratuito',
      freeDesc: 'Fino a 30.000 caratteri (una tantum)',
      standard: 'Standard',
    ...
    hi: {
      ...
      free: 'निःशुल्क योजना',
      freeDesc: '30,000 अक्षरों तक (एक बार)',
      standard: 'स्टैंडर्ड',
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="grid md:grid-cols-3 gap-4">
          <div class="p-4 border rounded-lg"><h3 class="font-bold text-gray-800">${c.free}</h3><p class="text-2xl font-bold text-gray-900">¥0</p><p class="text-sm text-gray-600">${c.freeDesc}</p></div>
          <div class="p-4 border-2 border-yellow-500 rounded-lg bg-yellow-50"><h3 class="font-bold text-gray-800">${c.standard}</h3><p class="text-2xl font-bold text-gray-900">¥1,000</p><p class="text-sm text-gray-600">${c.standardDesc}</p></div>
          <div class="p-4 border-2 border-purple-500 rounded-lg bg-purple-50"><h3 class="font-bold text-gray-800">${c.premium}</h3><p class="text-2xl font-bold text-gray-900">¥10,000</p><p class="text-sm text-gray-600">${c.premiumDesc}</p></div>
        </div>
      </div>
      <div class="bg-white rounded-lg shadow-lg p-6">
