  ...
  terms: {
    ...
    en: {
      ...
      sections: [
        ...
        { title: 'Article 3 (Pricing)', list: ['Free Plan: Up to 30,000 characters (one-time)', 'Standard Plan: $10 for 500,000 characters', 'Premium Plan: $100 for 6,000,000 characters'] },
    ...
    zh: {
      ...
      sections: [
        ...
        { title: '第3条（费用）', list: ['免费方案：最多30,000字符（仅限一次）', '标准方案：$10可获得500,000字符', '高级方案：$100可获得6,000,000字符'] },
    ...
    ko: {
      ...
      sections: [
        ...
        { title: '제3조 (요금)', list: ['무료 플랜: 30,000자까지 (1회 한정)', '스탠다드 플랜: $10으로 500,000자', '프리미엄 플랜: $100으로 6,000,000자'] },
    ...
    it: {
      ...
      sections: [
        ...
        { title: 'Articolo 3 (Prezzi)', list: ['Piano Gratuito: fino a 30.000 caratteri (una tantum)', 'Piano Standard: $10 per 500.000 caratteri', 'Piano Premium: $100 per 6.000.000 caratteri'] },
    ...
    hi: {
      ...
      sections: [
        ...
        { title: 'अनुच्छेद 3 (मूल्य निर्धारण)', list: ['निःशुल्क योजना: 30,000 अक्षरों तक (एक बार)', 'स्टैंडर्ड योजना: $10 में 500,000 अक्षर', 'प्रीमियम योजना: $100 में 6,000,000 अक्षर'] },
