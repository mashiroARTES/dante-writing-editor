...
const pageContent: { [key: string]: { [key: string]: any } } = {
  ...
  help: {
    ja: {
      ...
      feature5: '参照プロジェクト（ナレッジ機能）',
      feature5Text: '他のプロジェクトの内容をAI生成時のコンテキストとして活用。プロット、アイデア、執筆済み文章を参照して一貫性のある文章を生成できます',
      pricing: '料金プラン',
      free: '無料プラン',
    ...
    en: {
      ...
      feature5: 'Reference Projects (Knowledge Feature)',
      feature5Text: 'Use other projects as context for AI generation. Reference plots, ideas, and written text to generate consistent content',
    ...
    zh: {
      ...
      feature5: '参考项目',
      feature5Text: '选择其他项目作为AI生成的参考，利用过去的创意和情节作为知识库',
      pricing: '价格方案',
      free: '免费方案',
    ...
    ko: {
      ...
      feature5: '참조 프로젝트',
      feature5Text: '다른 프로젝트를 AI 생성의 참조로 선택하고, 과거의 아이디어와 플롯을 지식으로 활용',
      pricing: '요금제',
      free: '무료 플랜',
    ...
    it: {
      ...
      feature5: 'Progetti di Riferimento',
      feature5Text: 'Seleziona altri progetti come riferimento per la generazione AI, utilizzando idee e trame passate come base di conoscenza',
    ...
    hi: {
      ...
      feature5: 'संदर्भ परियोजनाएं',
      feature5Text: 'AI जनरेशन के लिए अन्य परियोजनाओं को संदर्भ के रूप में चुनें, पिछले विचारों और कथानक को ज्ञान के रूप में उपयोग करें',
    ...
    es: {
      ...
      feature5: 'Proyectos de Referencia',
      feature5Text: 'Selecciona otros proyectos como referencia para la generación de IA, utilizando ideas y tramas pasadas como base de conocimiento',
    ...
    fr: {
      ...
      feature5: 'Projets de Référence',
      feature5Text: 'Sélectionnez d\'autres projets comme référence pour la génération IA, en utilisant les idées et scénarios passés comme base de connaissances',
    ...
    de: {
      ...
      feature5: 'Referenzprojekte',
      feature5Text: 'Wählen Sie andere Projekte als Referenz für die KI-Generierung aus und nutzen Sie vergangene Ideen und Plots als Wissensbasis',
      pricing: 'Preispläne',
    ...
    pt: {
      ...
      feature5: 'Projetos de Referência',
      feature5Text: 'Selecione outros projetos como referência para geração de IA, utilizando ideias e enredos passados como base de conhecimento',
    ...
    ru: {
      ...
      feature5: 'Референсные проекты',
      feature5Text: 'Выберите другие проекты в качестве референса для генерации ИИ, используя прошлые идеи и сюжеты как базу знаний',
    ...
    ar: {
      ...
      feature5: 'مشاريع مرجعية',
      feature5Text: 'اختر مشاريع أخرى كمرجع لتوليد الذكاء الاصطناعي، مستخدماً الأفكار والحبكات السابقة كقاعدة معرفية',
      pricing: 'خطط الأسعار',
      free: 'الخطة المجانية',
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="grid md:grid-cols-2 gap-4">
          ...
          <div class="p-4 bg-blue-50 rounded-lg border-2 border-blue-300 md:col-span-2"><h3 class="font-bold text-gray-800"><i class="fas fa-project-diagram text-blue-600 mr-2"></i>${c.feature5}</h3><p class="text-sm text-gray-600">${c.feature5Text}</p></div>
        </div>
      </div>
      <div class="bg-white rounded-lg shadow-lg p-6">
